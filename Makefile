...
# --- Wasm apps ---
.PHONY: wasm clean clean-maclinux clean-stm32 clean-zephyr clean-all
...
# --- Zephyr (Docker) ---
.PHONY: zephyr-nucleo zephyr-nrf52840 flash-nucleo flash-nrf52840
zephyr-nucleo:
...
# --- Clean all ---
clean: clean-maclinux clean-stm32 clean-zephyr
